...
uint8_t recieve(nxt_device_t *nxt, struct recieve_message *rec_msg);
uint8_t check_firmware(nxt_device_t *nxt , struct send_message *msg , struct recieve_message *rec_msg);
