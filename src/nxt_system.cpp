...
namespace nxt_hardware {
  ...
  vector<hardware_interface::StateInterface>NXTSystem::export_state_interfaces(){
  ...
  vector<hardware_interface::CommandInterface>NXTSystem::export_command_interfaces(){
